...
namespace {
	...
	TEST_F(UnsignedBigIntTest, Bitwise) {
		...
		ASSERT_STREQ((a & b).toString().c_str(), "83164478193824044049423");
		...
		ASSERT_STREQ((a | b).toString().c_str(), "83164530448302805224239");
		...
		ASSERT_STREQ((a ^ b).toString().c_str(), "52254478761174816");
		...
		ASSERT_STREQ((~a).toString().c_str(), "429488413137813131173713620464");
	...
	TEST_F(UnsignedBigIntTest, Summary) {
		...
		ASSERT_STREQ((pow(b,2)).toString().c_str(), (a * a * 4).toString().c_str());
	...
	TEST_F(BigIntTest, Bitwise) {
		...
		ASSERT_STREQ((a & b).toString().c_str(), "-1");
		ASSERT_STREQ((a | b).toString().c_str(), "11");
		ASSERT_STREQ((a ^ b).toString().c_str(), "10");
		ASSERT_STREQ((~a).toString().c_str(), "-4294967294");
